		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Personel Talep Formu",
									"targetURL": "#ozakcomzhrpersonalrequestform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ozakcomzhrpersonalrequestform-display": {
								"semanticObject": "ozakcomzhrpersonalrequestform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ozak.com.zhrpersonalrequestform",
									"url": sap.ui.require.toUrl("ozak/com/zhrpersonalrequestform")
								}
							}
						}
					}
